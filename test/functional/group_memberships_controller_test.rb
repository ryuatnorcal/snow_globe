...
class GroupMembershipsControllerTest < ActionController::TestCase
  ...
  test "should create group_membership" do
    assert_difference('GroupMembership.count') do
      post :create, group_membership: { group_id: @group_membership.group_id, user_id: @group_membership.user_id }
    end
  ...
  test "should update group_membership" do
    put :update, id: @group_membership, group_membership: { group_id: @group_membership.group_id, user_id: @group_membership.user_id }
    assert_redirected_to group_membership_path(assigns(:group_membership))
  end
